...
namespace Common.Net
{
    public class HttpClientConfig
    {
        ...
        [JsonProperty("baseHeaders")] public Dictionary<string, string> BaseHeaders { get; set; }

        [JsonProperty("extraParams")] public Dictionary<string, string> ExtraParams { get; set; }
