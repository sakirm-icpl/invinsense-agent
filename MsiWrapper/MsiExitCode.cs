...
namespace MsiWrapper
{
    ...
    public enum MsiExitCode
    {
        ...
        ///     ERROR_INVALID_DATA
        /// </value>
        [Description("The data is invalid.")] InvalidDataError = 13,
        ...
        ///     dialog informing the user and asking whether to try to install anyway.
        ...
        ///     Verify that the package exists and that you can access it, or contact the application vendor to verify that this is
        ...
        ///     Verify that the patch package exists and that you can access it, or contact the application vendor to verify that
        ...
        /// <summary>
        ///     The installer cannot install the upgrade patch because the program being upgraded may be missing or the upgrade
        ...
        /// <summary>
        ///     Administrative user failed to apply patch for a per-user managed or a per-machine application that is in advertise
        ///     state.
        ///     Available beginning with Windows Installer version 3.0.
        /// </summary>
        /// <value>
        ...
        ///     A Windows Installer package, patch, or transform that has not been signed by Microsoft cannot be installed on an
        ///     ARM computer.
        /// </summary>
        /// <value>
