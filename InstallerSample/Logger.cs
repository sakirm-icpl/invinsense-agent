...
namespace InstallerSample
{
    ...
    public sealed class LogMessageInfo : EventArgs
    {
        ...
        public bool IsError => InstallerSample.Logger.ERROR.Equals(Level, StringComparison.Ordinal);
        public bool IsWarning => InstallerSample.Logger.WARN.Equals(Level, StringComparison.Ordinal);
        public bool IsInformation => InstallerSample.Logger.INFO.Equals(Level, StringComparison.Ordinal);
        public bool IsDebug => InstallerSample.Logger.DEBUG.Equals(Level, StringComparison.Ordinal);
