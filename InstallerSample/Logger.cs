...
namespace InstallerSample
{
    ...
    public sealed class LogMessageInfo : EventArgs
    {
        ...
        public bool IsError { get { return InstallerSample.Logger.ERROR.Equals(Level, StringComparison.Ordinal); } }
        public bool IsWarning { get { return InstallerSample.Logger.WARN.Equals(Level, StringComparison.Ordinal); } }
        public bool IsInformation { get { return InstallerSample.Logger.INFO.Equals(Level, StringComparison.Ordinal); } }
        public bool IsDebug { get { return InstallerSample.Logger.DEBUG.Equals(Level, StringComparison.Ordinal); } }
