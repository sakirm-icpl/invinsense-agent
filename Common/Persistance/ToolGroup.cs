namespace Common.Persistence
{
    ...
    {
        public static ToolGroup EndpointDetectionAndResponse =
            new ToolGroup(100, "ENDPOINT_DETECTION_AND_RESPONSE", "Endpoint Detection and Response");
        ...
        public static ToolGroup UserBehaviorAnalytics =
            new ToolGroup(400, "USER_BEHAVIOUR_ANALYTICS", "User Behavior Analytics");

        public static ToolGroup EndpointProtection = new ToolGroup(500, "ENDPOINT_PROTECTION", "Endpoint Protection");

        public static ToolGroup LateralMovementProtection =
            new ToolGroup(600, "LATERAL_MOVEMENT_PROTECTION", "Lateral Movement Protection");
