...
public class KeycloakAuthenticationOptions : OAuthOptions
{
    ...
    public KeycloakAuthenticationOptions()
    {
        ...
        EndSessionEndpoint = KeycloakAuthenticationDefaults.EndSessionEndpoint;
    ...
    public override void Validate()
    {
        ...
        catch (ArgumentException ex) when (ex.ParamName == nameof(ClientId) && AccessType == KeycloakAuthenticationAccessType.Public)
        {
